...
using ClassDependencyTracker.Specs.Drivers;

namespace ClassDependencyTracker.Specs.StepDefinitions;

[Binding]
public sealed class StepDefinitions (ClassDependencyTrackerForm form)
{
    private readonly ClassDependencyTrackerForm _form = form;
