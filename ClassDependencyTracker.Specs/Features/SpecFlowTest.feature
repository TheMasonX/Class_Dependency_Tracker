...
![SpecFlowTest](https://github.com/TheMasonX/ClassDependencyTracker/)
Simple calculator for adding **two** numbers

Link to a feature: [SpecFlowTest](ClassDependencyTracker.Specs/Features/SpecFlowTest.feature)
